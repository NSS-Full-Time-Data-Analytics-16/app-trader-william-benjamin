...
SELECT   apple_genre, -- google_genre, google_category
         COUNT(DISTINCT name), (longevity_months * 9000 - aquire_cost::numeric)::money 
         AS net_income --, aquire_cost, rounded_rating, longevity_months::integer,
FROM     final_cte
GROUP BY net_income, apple_genre
ORDER BY net_income DESC, COUNT DESC,apple_genre
-- LIMIT 110
